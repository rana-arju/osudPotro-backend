...
router.get('/user/:userId/orders', (0, auth_1.default)(auth_interface_1.USER_ROLE.admin), auth_controller_1.authController.getUserOrder);
...
router.delete('/user/:id', (0, auth_1.default)(auth_interface_1.USER_ROLE.admin), auth_controller_1.authController.deleteByAdmin);
